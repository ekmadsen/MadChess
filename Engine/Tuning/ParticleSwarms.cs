...
public sealed class ParticleSwarms : List<ParticleSwarm>
{
    ...
    public static Parameters CreateParameters()
    {
        return new Parameters
        {
            ...
            // Endgame Scale
            new(nameof(EvalConfig.EgScaleOnlyOppBishopsPerPassedPawn), 0, 128),
            new(nameof(EvalConfig.EgScaleOppBishopsPerPiece), 0, 32),
            new(nameof(EvalConfig.EgScaleOppBishops), 0, 128),
    ...
    private static void SetDefaultParameters(Parameters parameters)
    {
        ...
        // Endgame Scale
        parameters[nameof(evalConfig.EgScaleOnlyOppBishopsPerPassedPawn)].Value = evalConfig.EgScaleOnlyOppBishopsPerPassedPawn;
        parameters[nameof(evalConfig.EgScaleOppBishopsPerPiece)].Value = evalConfig.EgScaleOppBishopsPerPiece;
        parameters[nameof(evalConfig.EgScaleOppBishops)].Value = evalConfig.EgScaleOppBishops;
