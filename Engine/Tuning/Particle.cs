...
public sealed class Particle
{
    ...
    public void ConfigureEvaluation(Eval eval)
    {
        ...
        // Endgame Scale
        eval.Config.EgScaleOnlyOppBishopsPerPassedPawn = Parameters[nameof(EvalConfig.EgScaleOnlyOppBishopsPerPassedPawn)].Value;
        eval.Config.EgScaleOppBishopsPerPiece = Parameters[nameof(EvalConfig.EgScaleOppBishopsPerPiece)].Value;
        eval.Config.EgScaleOppBishops = Parameters[nameof(EvalConfig.EgScaleOppBishops)].Value;
