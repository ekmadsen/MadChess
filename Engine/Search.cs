    ...
    public sealed class Search : IDisposable
    {
        ...
        public int GetQuietScore(Board Board, int Depth, int Horizon, ulong ToSquareMask, int Alpha, int Beta)
        {
            ...
            do
            {
                ...
                if (IsMoveFutile(Board.CurrentPosition, Depth, Horizon, move, legalMoveNumber, 1, staticScore, drawnEndgame, Alpha, Beta)) continue; // Move is futile.  Skip move.
                // Play and search move.
                Board.PlayMove(move);
