...
public sealed class EvalConfig
{
    ...
    public int EgKnightMaterial = 697;
    public int MgBishopMaterial = 330;
    public int EgBishopMaterial = 723;
    public int MgRookMaterial = 500;
    public int EgRookMaterial = 1225;
    public int MgQueenMaterial = 975;
    public int EgQueenMaterial = 2331;
    // Passed Pawns
    public int PassedPawnPowerPer128 = 321;
    public int MgPassedPawnScalePer128 = 71;
    public int EgPassedPawnScalePer128 = 278;
    public int EgFreePassedPawnScalePer128 = 713;
    ...
    // King Safety
    public int MgKingSafetyPowerPer128 = 211;
    public int MgKingSafetyScalePer128 = 86;
    public int MgKingSafetyMinorAttackOuterRingPer8 = 19;
    public int MgKingSafetyMinorAttackInnerRingPer8 = 26;
    public int MgKingSafetyRookAttackOuterRingPer8 = 16;
    ...
    public int MgKingSafetyPawnShieldPer8 = 18;
    public int MgKingSafetyDefendingPiecesPer8 = 10;
    public int MgKingSafetyAttackingPiecesPer8 = 15;
    // Pawn Location
    ...
    public int MgQueenCorner = -10;
    public int EgQueenCorner = -6;
    // King Location
    public int MgKingAdvancement = -15;
    public int EgKingAdvancement = 19;
    public int MgKingCentrality = 0;
    public int EgKingCentrality = 24;
    ...
    public int EgBishopMobilityScale = 154;
    public int MgRookMobilityScale = 75;
    public int EgRookMobilityScale = 120;
    public int MgQueenMobilityScale = 101;
    public int EgQueenMobilityScale = 29;
    // Pawn Structure
    public int MgIsolatedPawn = 11;
    public int EgIsolatedPawn = 50;
    ...
    public int EgPawnThreatenMajor = 24;
    public int MgMinorThreatenMajor = 19;
    public int EgMinorThreatenMajor = 40;
    // Minor Pieces
    public int MgBishopPair = 46;
    public int EgBishopPair = 95;
    public int MgKnightOutpost = 61;
    public int EgKnightOutpost = 63;
    public int MgBishopOutpost = 46;
    public int EgBishopOutpost = 11;
    // Major Pieces
    // ReSharper disable InconsistentNaming
    public int MgRook7thRank = 72;
    public int EgRook7thRank = 53;
    // ReSharper restore InconsistentNaming
    // Endgame Scale
    public int EgScaleMinorAdvantage = 9;
    public int EgScaleOppBishopsPerPassedPawn = 34;
    public int EgScalePerPawnAdvantage = 8;
    // Limit Strength
